 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ne=function(i,e){if(!i)throw al(e)},al=function(i){return new Error("Firebase Database ("+mA.SDK_VERSION+") INTERNAL ASSERT FAILED: "+i)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const X1="FirebaseError";class Is extends Error{constructor(e,t,s){super(t),this.code=e,this.customData=s,this.name=X1,Object.setPrototypeOf(this,Is.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,dc.prototype.create)}}class dc{constructor(e,t,s){this.service=e,this.serviceName=t,this.errors=s}create(e,...t){const s=t[0]||{},a=`${this.service}/${e}`,l=this.errors[e],c=l?W1(l,s):"Error",d=`${this.serviceName}: ${c} (${a}).`;return new Is(a,d,s)}}function W1(i,e){return i.replace($1,(t,s)=>{const a=e[s];return a!=null?String(a):`<${s}?>`})}const $1=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wA=function(i){let e={},t={},s={},a="";try{const l=i.split(".");e=Yu(vf(l[0])||""),t=Yu(vf(l[1])||""),a=l[2],s=t.d||{},delete t.d}catch{}return{header:e,claims:t,data:s,signature:a}},Z1=function(i){const e=wA(i),t=e.claims;return!!t&&typeof t=="object"&&t.hasOwnProperty("iat")},J1=function(i){const e=wA(i).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const iN="firebase-heartbeat-database",sN=1,Ku="firebase-heartbeat-store";let Wp=null;function IA(){return Wp||(Wp=TI(iN,sN,{upgrade:(i,e)=>{switch(e){case 0:try{i.createObjectStore(Ku)}catch(t){console.warn(t)}}}}).catch(i=>{throw dr.create("idb-open",{originalErrorMessage:i.message})})),Wp}async function rN(i){try{const t=(await IA()).transaction(Ku),s=await t.objectStore(Ku).get(NA(i));return await t.done,s}catch(e){if(e instanceof Is)Ss.warn(e.message);else{const t=dr.create("idb-get",{originalErrorMessage:e?.message});Ss.warn(t.message)}}}async function c0(i,e){try{const s=(await IA()).transaction(Ku,"readwrite");await s.objectStore(Ku).put(e,NA(i)),await s.done}catch(t){if(t instanceof Is)Ss.warn(t.message);else{const s=dr.create("idb-set",{originalErrorMessage:t?.message});Ss.warn(s.message)}}}function NA(i){return`${i.name}!${i.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Mi(dN,mN,"app");function DA(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const pN=DA,OA=new dc("auth","Firebase",DA());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mc{constructor(e,t){this.shortDelay=e,this.longDelay=t,As(t>e,"Short delay should be less than long delay!"),this.isMobile=i_()||AA()}get(){return vN()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const SN=["/v1/accounts:signInWithCustomToken","/v1/accounts:signInWithEmailLink","/v1/accounts:signInWithIdp","/v1/accounts:signInWithPassword","/v1/accounts:signInWithPhoneNumber","/v1/token"],AN=new mc(3e4,6e4);function u_(i,e){return i.tenantId&&!e.tenantId?{...e,tenantId:i.tenantId}:e}async function ll(i,e,t,s,a={}){return xA(i,a,async()=>{let l={},c={};s&&(e==="GET"?c=s:l={body:JSON.stringify(s)});const d=ol({key:i.config.apiKey,...c}).slice(1),p=await i._getAdditionalHeaders();p["Content-Type"]="application/json",i.languageCode&&(p["X-Firebase-Locale"]=i.languageCode);const g={method:e,headers:p,...l};return F1()||(g.referrerPolicy="no-referrer"),i.emulatorConfig&&Dr(i.emulatorConfig.host)&&(g.credentials="include"),MA.fetch()(await kA(i,i.config.apiHost,t,d),g)})}async function xA(i,e,t){i._canInitEmulator=!1;const s={...TN,...e};try{const a=new bN(i),l=await Promise.race([t(),a.promise]);a.clearNetworkTimeout();const c=await l.json();if("needConfirmation"in c)throw Zh(i,"account-exists-with-different-credential",c);if(l.ok&&!("errorMessage"in c))return c;{const d=l.ok?c.errorMessage:c.error.message,[p,g]=d.split(" : ");if(p==="FEDERATED_USER_ID_ALREADY_LINKED")throw Zh(i,"credential-already-in-use",c);if(p==="EMAIL_EXISTS")throw Zh(i,"email-already-in-use",c);if(p==="USER_DISABLED")throw Zh(i,"user-disabled",c);const v=s[p]||p.toLowerCase().replace(/[_\s]+/g,"-");if(g)throw a_(i,v,g);Ui(i,v)}}catch(a){if(a instanceof Is)throw a;Ui(i,"network-request-failed",{message:String(a)})}}async function wN(i,e,t,s,a={}){const l=await ll(i,e,t,s,a);return"mfaPendingCredential"in l&&Ui(i,"multi-factor-auth-required",{_serverResponse:l}),l}async function kA(i,e,t,s){const a=`${e}${t}?${s}`,l=i,c=l.config.emulator?l_(i.config,a):`${i.config.apiScheme}://${a}`;return SN.includes(t)&&(await l._persistenceManagerAvailable,l._getPersistenceType()==="COOKIE")?l._getPersistence()._getFinalTarget(c).toString():c}class bN{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((t,s)=>{this.timer=setTimeout(()=>s(ci(this.auth,"network-request-failed")),AN.get())})}}function Zh(i,e,t){const s={appName:i.name};t.email&&(s.email=t.email),t.phoneNumber&&(s.phoneNumber=t.phoneNumber);const a=ci(i,e,s);return a.customData._tokenResponse=t,a}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function CN(i,e){return ll(i,"POST","/v1/accounts:delete",e)}async function wf(i,e){return ll(i,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Xu(i,e,t=!1){if(t)return e;try{return await e}catch(s){throw s instanceof Is&&IN(s)&&i.auth.currentUser===i&&await i.auth.signOut(),s}}function IN({code:i}){return i==="auth/user-disabled"||i==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function MN(i,e){const t=await xA(i,{},async()=>{const s=ol({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:a,apiKey:l}=i.config,c=await kA(i,a,"/v1/token",`key=${l}`),d=await i._getAdditionalHeaders();d["Content-Type"]="application/x-www-form-urlencoded";const p={method:"POST",headers:d,body:s};return i.emulatorConfig&&Dr(i.emulatorConfig.host)&&(p.credentials="include"),MA.fetch()(c,p)});return{accessToken:t.access_token,expiresIn:t.expires_in,refreshToken:t.refresh_token}}async function xN(i,e){return ll(i,"POST","/v2/accounts:revokeToken",u_(i,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _0(i){const e=i.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(qA(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(LA(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(FA(e))return"Blackberry";if(jA(e))return"Webos";if(UA(e))return"Safari";if((e.includes("chrome/")||zA(e))&&!e.includes("edge/"))return"Chrome";if(BA(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,s=i.match(t);if(s?.length===2)return s[1]}return"Other"}function LA(i=dn()){return/firefox\//i.test(i)}function UA(i=dn()){const e=i.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function zA(i=dn()){return/crios\//i.test(i)}function qA(i=dn()){return/iemobile/i.test(i)}function BA(i=dn()){return/android/i.test(i)}function FA(i=dn()){return/blackberry/i.test(i)}function jA(i=dn()){return/webos/i.test(i)}function h_(i=dn()){return/iphone|ipad|ipod/i.test(i)||/macintosh/i.test(i)&&/mobile/i.test(i)}function kN(i=dn()){return h_(i)&&!!window.navigator?.standalone}function PN(){return H1()&&document.documentMode===10}function HA(i=dn()){return h_(i)||BA(i)||jA(i)||FA(i)||/windows phone/i.test(i)||qA(i)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function LN(i,e={}){return ll(i,"GET","/v2/passwordPolicy",u_(i,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let f_={async loadJS(){throw new Error("Unable to load external scripts")},recaptchaV2Script:"",recaptchaEnterpriseScript:"",gapiScript:""};function BN(i){f_=i}function FN(i){return f_.loadJS(i)}function jN(){return f_.gapiScript}function HN(i){return`__${i}${Math.floor(Math.random()*1e6)}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Bo(i,e){return wN(i,"POST","/v1/accounts:signInWithIdp",u_(i,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function kD(i,e={}){return ll(i,"GET","/v1/projects",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zD=new mc(3e4,6e4);function w0(){const i=xi().___jsl;if(i?.H){for(const e of Object.keys(i.H))if(i.H[e].r=i.H[e].r||[],i.H[e].L=i.H[e].L||[],i.H[e].r=[...i.H[e].L],i.CP)for(let t=0;t<i.CP.length;t++)i.CP[t]=null}}function qD(i){return new Promise((e,t)=>{function s(){w0(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{w0(),t(ci(i,"network-request-failed"))},timeout:zD.get()})}if(xi().gapi?.iframes?.Iframe)e(gapi.iframes.getContext());else if(xi().gapi?.load)s();else{const a=HN("iframefcb");return xi()[a]=()=>{gapi.load?s():t(ci(i,"network-request-failed"))},FN(`${jN()}?onload=${a}`).catch(l=>t(l))}}).catch(e=>{throw cf=null,e})}let cf=null;function BD(i){return cf=cf||qD(i),cf}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const FD=new mc(5e3,15e3),jD="__/auth/iframe",HD="emulator/auth/iframe",GD={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},QD=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function YD(i){const e=i.config;Ee(e.authDomain,i,"auth-domain-config-required");const t=e.emulator?l_(e,HD):`https://${i.config.authDomain}/${jD}`,s={apiKey:e.apiKey,appName:i.name,v:Pa},a=QD.get(i.config.apiHost);a&&(s.eid=a);const l=i._getFrameworks();return l.length&&(s.fw=l.join(",")),`${t}?${ol(s).slice(1)}`}async function KD(i){const e=await BD(i),t=xi().gapi;return Ee(t,i,"internal-error"),e.open({where:document.body,url:YD(i),messageHandlersFilter:t.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:GD,dontclear:!0},s=>new Promise(async(a,l)=>{await s.restyle({setHideOnLeave:!1});const c=ci(i,"network-request-failed"),d=xi().setTimeout(()=>{l(c)},FD.get());function p(){xi().clearTimeout(d),a(s)}s.ping(p).then(p,()=>{l(c)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function u2(i){switch(i){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function c2(i){Ca(new Er("auth",(e,{options:t})=>{const s=e.getProvider("app").getImmediate(),a=e.getProvider("heartbeat"),l=e.getProvider("app-check-internal"),{apiKey:c,authDomain:d}=s.options;Ee(c&&!c.includes(":"),"invalid-api-key",{appName:s.name});const p={apiKey:c,authDomain:d,clientPlatform:i,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:GA(i)},g=new qN(s,a,l,p);return QN(g,t),g},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,s)=>{e.getProvider("auth-internal").initialize()})),Ca(new Er("auth-internal",e=>{const t=ad(e.getProvider("auth").getImmediate());return(s=>new l2(s))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),Mi(R0,I0,u2(i)),Mi(R0,I0,"esm2020")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _e(i,e,t){let s="Unexpected state";typeof e=="string"?s=e:t=e,fw(i,s,t)}function fw(i,e,t){let s=`FIRESTORE (${ul}) INTERNAL ASSERTION FAILED: ${e} (ID: ${i.toString(16)})`;if(t!==void 0)try{s+=" CONTEXT: "+JSON.stringify(t)}catch{s+=" CONTEXT: "+t}throw ws(s),new Error(s)}function Ke(i,e,t,s){let a="Unexpected state";typeof t=="string"?a=t:s=t,i||fw(e,a,s)}function Ae(i,e){return i}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xt(i,e){const t={typeString:i};return e&&(t.value=e),t}function _c(i,e){if(!pw(i))throw new re(Y.INVALID_ARGUMENT,"JSON must be an object");let t;for(const s in e)if(e[s]){const a=e[s].typeString,l="value"in e[s]?{value:e[s].value}:void 0;if(!(s in i)){t=`JSON missing required field: '${s}'`;break}const c=i[s];if(a&&typeof c!==a){t=`JSON field '${s}' must be a ${a}.`;break}if(l!==void 0&&c!==l.value){t=`Expected '${s}' field to equal '${l.value}'`;break}}if(t)throw new re(Y.INVALID_ARGUMENT,t);return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wu=-1;function R2(i,e){const t=i.toTimestamp().seconds,s=i.toTimestamp().nanoseconds+1,a=Se.fromTimestamp(s===1e9?new ct(t+1,0):new ct(t,s));return new Tr(a,he.empty(),e)}function I2(i){return new Tr(i.readTime,i.key,Wu)}class Tr{constructor(e,t,s){this.readTime=e,this.documentKey=t,this.largestBatchId=s}static min(){return new Tr(Se.min(),he.empty(),Wu)}static max(){return new Tr(Se.max(),he.empty(),Wu)}}function N2(i,e){let t=i.readTime.compareTo(e.readTime);return t!==0?t:(t=he.comparator(i.documentKey,e.documentKey),t!==0?t:Pe(i.largestBatchId,e.largestBatchId))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function cl(i){if(i.code!==Y.FAILED_PRECONDITION||i.message!==D2)throw i;ae("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function q0(i){let e=0;for(const t in i)Object.prototype.hasOwnProperty.call(i,t)&&e++;return e}function Or(i,e){for(const t in i)Object.prototype.hasOwnProperty.call(i,t)&&e(t,i[t])}function _w(i){for(const e in i)if(Object.prototype.hasOwnProperty.call(i,e))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vw="server_timestamp",Ew="__type__",Tw="__previous_value__",Sw="__local_write_time__";function v_(i){return(i?.mapValue?.fields||{})[Ew]?.stringValue===vw}function fd(i){const e=i.mapValue.fields[Tw];return v_(e)?fd(e):e}function $u(i){const e=Sr(i.mapValue.fields[Sw].timestampValue);return new ct(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ec{constructor(e,t="asc"){this.field=e,this.dir=t}}function B2(i,e){return i.dir===e.dir&&i.field.isEqual(e.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tO=new kt(he.comparator);function bs(){return tO}const Pw=new kt(he.comparator);function Mu(...i){let e=Pw;for(const t of i)e=e.insert(t.key,t);return e}function Vw(i){let e=Pw;return i.forEach(((t,s)=>e=e.insert(t,s.overlayedDocument))),e}function Ea(){return qu()}function Lw(){return qu()}function qu(){return new Va((i=>i.toString()),((i,e)=>i.isEqual(e)))}const nO=new kt(he.comparator),iO=new qt(he.comparator);function Ve(...i){let e=iO;for(const t of i)e=e.add(t);return e}const sO=new qt(Pe);function rO(){return sO}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gd{constructor(){this._=void 0}}function oO(i,e,t){return i instanceof tc?(function(a,l){const c={fields:{[Ew]:{stringValue:vw},[Sw]:{timestampValue:{seconds:a.seconds,nanos:a.nanoseconds}}}};return l&&v_(l)&&(l=fd(l)),l&&(c.fields[Tw]=l),{mapValue:c}})(t,e):i instanceof nc?qw(i,e):i instanceof ic?Bw(i,e):(function(a,l){const c=zw(a,l),d=$0(c)+$0(a.Ae);return Ag(c)&&Ag(a.Ae)?Uw(d):A_(a.serializer,d)})(i,e)}function lO(i,e,t){return i instanceof nc?qw(i,e):i instanceof ic?Bw(i,e):t}function zw(i,e){return i instanceof kf?(function(s){return Ag(s)||(function(l){return!!l&&"doubleValue"in l})(s)})(e)?e:{integerValue:0}:null}class tc extends gd{}class nc extends gd{constructor(e){super(),this.elements=e}}function qw(i,e){const t=Fw(e);for(const s of i.elements)t.some((a=>zi(a,s)))||t.push(s);return{arrayValue:{values:t}}}class ic extends gd{constructor(e){super(),this.elements=e}}function Bw(i,e){let t=Fw(e);for(const s of i.elements)t=t.filter((a=>!zi(a,s)));return{arrayValue:{values:t}}}class kf extends gd{constructor(e,t){super(),this.serializer=e,this.Ae=t}}function $0(i){return wt(i.integerValue||i.doubleValue)}function Fw(i){return E_(i)&&i.arrayValue.values?i.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class uO{constructor(e,t){this.field=e,this.transform=t}}function cO(i,e){return i.field.isEqual(e.field)&&(function(s,a){return s instanceof nc&&a instanceof nc||s instanceof ic&&a instanceof ic?Wo(s.elements,a.elements,zi):s instanceof kf&&a instanceof kf?zi(s.Ae,a.Ae):s instanceof tc&&a instanceof tc})(i.transform,e.transform)}class hO{constructor(e,t){this.version=e,this.transformResults=t}}class hi{constructor(e,t){this.updateTime=e,this.exists=t}static none(){return new hi}static exists(e){return new hi(void 0,e)}static updateTime(e){return new hi(e)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}function mf(i,e){return i.updateTime!==void 0?e.isFoundDocument()&&e.version.isEqual(i.updateTime):i.exists===void 0||i.exists===e.isFoundDocument()}class _d{}function jw(i,e){if(!i.hasLocalMutations||e&&e.fields.length===0)return null;if(e===null)return i.isNoDocument()?new Gw(i.key,hi.none()):new yc(i.key,i.data,hi.none());{const t=i.data,s=An.empty();let a=new qt(rn.comparator);for(let l of e.fields)if(!a.has(l)){let c=t.field(l);c===null&&l.length>1&&(l=l.popLast(),c=t.field(l)),c===null?s.delete(l):s.set(l,c),a=a.add(l)}return new Mr(i.key,s,new Ln(a.toArray()),hi.none())}}function fO(i,e,t){i instanceof yc?(function(a,l,c){const d=a.value.clone(),p=J0(a.fieldTransforms,l,c.transformResults);d.setAll(p),l.convertToFoundDocument(c.version,d).setHasCommittedMutations()})(i,e,t):i instanceof Mr?(function(a,l,c){if(!mf(a.precondition,l))return void l.convertToUnknownDocument(c.version);const d=J0(a.fieldTransforms,l,c.transformResults),p=l.data;p.setAll(Hw(a)),p.setAll(d),l.convertToFoundDocument(c.version,p).setHasCommittedMutations()})(i,e,t):(function(a,l,c){l.convertToNoDocument(c.version).setHasCommittedMutations()})(0,e,t)}function Bu(i,e,t,s){return i instanceof yc?(function(l,c,d,p){if(!mf(l.precondition,c))return d;const g=l.value.clone(),v=eS(l.fieldTransforms,p,c);return g.setAll(v),c.convertToFoundDocument(c.version,g).setHasLocalMutations(),null})(i,e,t,s):i instanceof Mr?(function(l,c,d,p){if(!mf(l.precondition,c))return d;const g=eS(l.fieldTransforms,p,c),v=c.data;return v.setAll(Hw(l)),v.setAll(g),c.convertToFoundDocument(c.version,v).setHasLocalMutations(),d===null?null:d.unionWith(l.fieldMask.fields).unionWith(l.fieldTransforms.map((T=>T.field)))})(i,e,t,s):(function(l,c,d){return mf(l.precondition,c)?(c.convertToNoDocument(c.version).setHasLocalMutations(),null):d})(i,e,t)}function dO(i,e){let t=null;for(const s of i.fieldTransforms){const a=e.data.field(s.field),l=zw(s.transform,a||null);l!=null&&(t===null&&(t=An.empty()),t.set(s.field,l))}return t||null}function Z0(i,e){return i.type===e.type&&!!i.key.isEqual(e.key)&&!!i.precondition.isEqual(e.precondition)&&!!(function(s,a){return s===void 0&&a===void 0||!(!s||!a)&&Wo(s,a,((l,c)=>cO(l,c)))})(i.fieldTransforms,e.fieldTransforms)&&(i.type===0?i.value.isEqual(e.value):i.type!==1||i.data.isEqual(e.data)&&i.fieldMask.isEqual(e.fieldMask))}class yc extends _d{constructor(e,t,s,a=[]){super(),this.key=e,this.value=t,this.precondition=s,this.fieldTransforms=a,this.type=0}getFieldMask(){return null}}class Mr extends _d{constructor(e,t,s,a,l=[]){super(),this.key=e,this.data=t,this.fieldMask=s,this.precondition=a,this.fieldTransforms=l,this.type=1}getFieldMask(){return this.fieldMask}}function Hw(i){const e=new Map;return i.fieldMask.fields.forEach((t=>{if(!t.isEmpty()){const s=i.data.field(t);e.set(t,s)}})),e}function J0(i,e,t){const s=new Map;Ke(i.length===t.length,32656,{Re:t.length,Ve:i.length});for(let a=0;a<t.length;a++){const l=i[a],c=l.transform,d=e.data.field(l.field);s.set(l.field,lO(c,d,t[a]))}return s}function eS(i,e,t){const s=new Map;for(const a of i){const l=a.transform,c=t.data.field(a.field);s.set(a.field,oO(l,c,e))}return s}class Gw extends _d{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class mO extends _d{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yd{constructor(e,t,s,a,l){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=s,this.documentUpdates=a,this.resolvedLimboDocuments=l}static createSynthesizedRemoteEventForCurrentChange(e,t,s){const a=new Map;return a.set(e,vc.createSynthesizedTargetChangeForCurrentChange(e,t,s)),new yd(Se.min(),a,new kt(Pe),bs(),Ve())}}class vc{constructor(e,t,s,a,l){this.resumeToken=e,this.current=t,this.addedDocuments=s,this.modifiedDocuments=a,this.removedDocuments=l}static createSynthesizedTargetChangeForCurrentChange(e,t,s){return new vc(s,t,Ve(),Ve(),Ve())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zO{constructor(e){this.yt=e}}function qO(i){const e=xO({parent:i.parent,structuredQuery:i.structuredQuery});return i.limitType==="LAST"?xf(e,e.limit,"L"):e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cn="WebChannelConnection";class TM extends vM{constructor(e){super(e),this.c_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Jo(e,t,s,a,l){const c=Mg();return new Promise(((d,p)=>{const g=new ow;g.setWithCredentials(!0),g.listenOnce(lw.COMPLETE,(()=>{try{switch(g.getLastErrorCode()){case hf.NO_ERROR:const T=g.getResponseJson();ae(cn,`XHR for RPC '${e}' ${c} received:`,JSON.stringify(T)),d(T);break;case hf.TIMEOUT:ae(cn,`RPC '${e}' ${c} timed out`),p(new re(Y.DEADLINE_EXCEEDED,"Request time out"));break;case hf.HTTP_ERROR:const A=g.getStatus();if(ae(cn,`RPC '${e}' ${c} failed with status:`,A,"response text:",g.getResponseText()),A>0){let O=g.getResponseJson();Array.isArray(O)&&(O=O[0]);const q=O?.error;if(q&&q.status&&q.message){const Z=(function(pe){const de=pe.toLowerCase().replace(/_/g,"-");return Object.values(Y).indexOf(de)>=0?de:Y.UNKNOWN})(q.status);p(new re(Z,q.message))}else p(new re(Y.UNKNOWN,"Server responded with status "+g.getStatus()))}else p(new re(Y.UNAVAILABLE,"Connection failed."));break;default:_e(9055,{l_:e,streamId:c,h_:g.getLastErrorCode(),P_:g.getLastError()})}}finally{ae(cn,`RPC '${e}' ${c} completed.`)}}));const v=JSON.stringify(a);ae(cn,`RPC '${e}' ${c} sending request:`,a),g.send(t,"POST",v,s,15)}))}T_(e,t,s){const a=Mg(),l=[this.Uo,"/","google.firestore.v1.Firestore","/",e,"/channel"],c=hw(),d=cw(),p={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},g=this.longPollingOptions.timeoutSeconds;g!==void 0&&(p.longPollingTimeout=Math.round(1e3*g)),this.useFetchStreams&&(p.useFetchStreams=!0),this.jo(p.initMessageHeaders,t,s),p.encodeInitMessageHeaders=!0;const v=l.join("");ae(cn,`Creating RPC '${e}' stream ${a}: ${v}`,p);const T=c.createWebChannel(v,p);this.I_(T);let A=!1,O=!1;const q=new EM({Yo:W=>{O?ae(cn,`Not sending because RPC '${e}' stream ${a} is closed:`,W):(A||(ae(cn,`Opening RPC '${e}' stream ${a} transport.`),T.open(),A=!0),ae(cn,`RPC '${e}' stream ${a} sending:`,W),T.send(W))},Zo:()=>T.close()}),Z=(W,pe,de)=>{W.listen(pe,(ue=>{try{de(ue)}catch(Fe){setTimeout((()=>{throw Fe}),0)}}))};return Z(T,Ou.EventType.OPEN,(()=>{O||(ae(cn,`RPC '${e}' stream ${a} transport opened.`),q.o_())})),Z(T,Ou.EventType.CLOSE,(()=>{O||(O=!0,ae(cn,`RPC '${e}' stream ${a} transport closed`),q.a_(),this.E_(T))})),Z(T,Ou.EventType.ERROR,(W=>{O||(O=!0,Xo(cn,`RPC '${e}' stream ${a} transport errored. Name:`,W.name,"Message:",W.message),q.a_(new re(Y.UNAVAILABLE,"The operation could not be completed")))})),Z(T,Ou.EventType.MESSAGE,(W=>{if(!O){const pe=W.data[0];Ke(!!pe,16349);const de=pe,ue=de?.error||de[0]?.error;if(ue){ae(cn,`RPC '${e}' stream ${a} received error:`,ue);const Fe=ue.status;let we=(function(b){const I=Dt[b];if(I!==void 0)return Qw(I)})(Fe),Qe=ue.message;we===void 0&&(we=Y.INTERNAL,Qe="Unknown error status: "+Fe+" with message "+ue.message),O=!0,q.a_(new re(we,Qe)),T.close()}else ae(cn,`RPC '${e}' stream ${a} received:`,pe),q.u_(pe)}})),Z(d,uw.STAT_EVENT,(W=>{W.stat===vg.PROXY?ae(cn,`RPC '${e}' stream ${a} detected buffering proxy`):W.stat===vg.NOPROXY&&ae(cn,`RPC '${e}' stream ${a} detected no buffering proxy`)})),setTimeout((()=>{q.__()}),0),q}terminate(){this.c_.forEach((e=>e.close())),this.c_=[]}I_(e){this.c_.push(e)}E_(e){this.c_=this.c_.filter((t=>t===e))}}function ng(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Li{constructor(e){this._values=(e||[]).map((t=>t))}toArray(){return this._values.map((e=>e))}isEqual(e){return(function(s,a){if(s.length!==a.length)return!1;for(let l=0;l<s.length;++l)if(s[l]!==a[l])return!1;return!0})(this._values,e._values)}toJSON(){return{type:Li._jsonSchemaVersion,vectorValues:this._values}}static fromJSON(e){if(_c(e,Li._jsonSchema)){if(Array.isArray(e.vectorValues)&&e.vectorValues.every((t=>typeof t=="number")))return new Li(e.vectorValues);throw new re(Y.INVALID_ARGUMENT,"Expected 'vectorValues' field to be a number array")}}}Li._jsonSchemaVersion="firestore/vectorValue/1.0",Li._jsonSchema={type:xt("string",Li._jsonSchemaVersion),vectorValues:xt("object")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pb(i){i=Un(i,Et);const e=Un(i.firestore,Rr);return cx(Ad(e),i._key).then((t=>Lb(e,i,t)))}ba._jsonSchemaVersion="firestore/querySnapshot/1.0",ba._jsonSchema={type:xt("string",ba._jsonSchemaVersion),bundleSource:xt("string","QuerySnapshot"),bundleName:xt("string"),bundle:xt("string")};class J_ extends bx{constructor(e){super(),this.firestore=e}convertBytes(e){return new Jn(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new Et(this.firestore,null,t)}}function DS(i){i=Un(i,Ns);const e=Un(i.firestore,Rr),t=Ad(e),s=new J_(e);return Mb(i._query),hx(t,i._query).then((a=>new ba(e,s,i,a)))}function Rx(i,e,t){i=Un(i,Et);const s=Un(i.firestore,Rr),a=kb(i.converter,e);return ey(s,[Rb(Cd(s),"setDoc",i._key,a,i.converter!==null,t).toMutation(i._key,hi.none())])}function sc(i,e,t,...s){i=Un(i,Et);const a=Un(i.firestore,Rr),l=Cd(a);let c;return c=typeof(e=dt(e))=="string"||e instanceof wd?vx(l,"updateDoc",i._key,e,t,s):yx(l,"updateDoc",i._key,e),ey(a,[c.toMutation(i._key,hi.exists(!0))])}function Vb(i,e){const t=Un(i.firestore,Rr),s=Da(i),a=kb(i.converter,e);return ey(t,[Rb(Cd(i.firestore),"addDoc",s._key,a,i.converter!==null,{}).toMutation(s._key,hi.exists(!1))]).then((()=>s))}function rc(i,...e){i=dt(i);let t={includeMetadataChanges:!1,source:"default"},s=0;typeof e[s]!="object"||RS(e[s])||(t=e[s++]);const a={includeMetadataChanges:t.includeMetadataChanges,source:t.source};if(RS(e[s])){const p=e[s];e[s]=p.next?.bind(p),e[s+1]=p.error?.bind(p),e[s+2]=p.complete?.bind(p)}let l,c,d;if(i instanceof Et)c=Un(i.firestore,Rr),d=dd(i._key.path),l={next:p=>{e[s]&&e[s](Lb(c,i,p))},error:e[s+1],complete:e[s+2]};else{const p=Un(i,Ns);c=Un(p.firestore,Rr),d=p._query;const g=new J_(c);l={next:v=>{e[s]&&e[s](new ba(c,g,p,v))},error:e[s+1],complete:e[s+2]},Mb(i._query)}return(function(g,v,T,A){const O=new j_(A),q=new q_(v,O,T);return g.asyncQueue.enqueueAndForget((async()=>L_(await zf(g),q))),()=>{O.Nu(),g.asyncQueue.enqueueAndForget((async()=>U_(await zf(g),q)))}})(Ad(c),d,a,l)}function ey(i,e){return(function(s,a){const l=new Es;return s.asyncQueue.enqueueAndForget((async()=>ZM(await ux(s),a,l))),l.promise})(Ad(i),e)}function Lb(i,e,t){const s=t.docs.get(e._key),a=new J_(i);return new wa(i,a,e._key,s,new ku(t.hasPendingWrites,t.fromCache),e.converter)}function hr(){return new G_("serverTimestamp")}(function(e,t=!0){(function(a){ul=a})(Pa),Ca(new Er("firestore",((s,{instanceIdentifier:a,options:l})=>{const c=s.getProvider("app").getImmediate(),d=new Rr(new y2(s.getProvider("auth-internal")),new T2(c,s.getProvider("app-check-internal")),(function(g,v){if(!Object.prototype.hasOwnProperty.apply(g.options,["projectId"]))throw new re(Y.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Zu(g.options.projectId,v)})(c,a),c);return l={useFetchStreams:t,...l},d._setSettings(l),d}),"PUBLIC").setMultipleInstances(!0)),Mi(O0,M0,e),Mi(O0,M0,"esm2020")})();var OS={};const MS="@firebase/database",xS="1.1.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dx{constructor(){this.cache_={},this.isInMemoryStorage=!0}set(e,t){t==null?delete this.cache_[e]:this.cache_[e]=t}get(e){return qi(this.cache_,e)?this.cache_[e]:null}remove(e){delete this.cache_[e]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yx{constructor(){this.counters_={}}incrementCounter(e,t=1){qi(this.counters_,e)||(this.counters_[e]=0),this.counters_[e]+=t}get(){return x1(this.counters_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xx{constructor(e){this.onMessage_=e,this.pendingResponses=[],this.currentResponseNum=0,this.closeAfterResponse=-1,this.onClose=null}closeAfter(e,t){this.closeAfterResponse=e,this.onClose=t,this.closeAfterResponse<this.currentResponseNum&&(this.onClose(),this.onClose=null)}handleResponse(e,t){for(this.pendingResponses[e]=t;this.pendingResponses[this.currentResponseNum];){const s=this.pendingResponses[this.currentResponseNum];delete this.pendingResponses[this.currentResponseNum];for(let a=0;a<s.length;++a)s[a]&&ml(()=>{this.onMessage_(s[a])});if(this.currentResponseNum===this.closeAfterResponse){this.onClose&&(this.onClose(),this.onClose=null);break}this.currentResponseNum++}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ac{static get ALL_TRANSPORTS(){return[Uo,oi]}static get IS_TRANSPORT_INITIALIZED(){return this.globalTransportInitialized_}constructor(e){this.initTransports_(e)}initTransports_(e){const t=oi&&oi.isAvailable();let s=t&&!oi.previouslyFailed();if(e.webSocketOnly&&(t||Cn("wss:// URL used, but browser isn't known to support websockets.  Trying anyway."),s=!0),s)this.transports_=[oi];else{const a=this.transports_=[];for(const l of ac.ALL_TRANSPORTS)l&&l.isAvailable()&&a.push(l);ac.globalTransportInitialized_=!0}}initialTransport(){if(this.transports_.length>0)return this.transports_[0];throw new Error("No transports available")}upgradeTransport(){return this.transports_.length>1?this.transports_[1]:null}}ac.globalTransportInitialized_=!1;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jS=32,HS=768;class Ze{constructor(e,t){if(t===void 0){this.pieces_=e.split("/");let s=0;for(let a=0;a<this.pieces_.length;a++)this.pieces_[a].length>0&&(this.pieces_[s]=this.pieces_[a],s++);this.pieces_.length=s,this.pieceNum_=0}else this.pieces_=e,this.pieceNum_=t}toString(){let e="";for(let t=this.pieceNum_;t<this.pieces_.length;t++)this.pieces_[t]!==""&&(e+="/"+this.pieces_[t]);return e||"/"}}function Ge(){return new Ze("")}function Re(i){return i.pieceNum_>=i.pieces_.length?null:i.pieces_[i.pieceNum_]}function Ir(i){return i.pieces_.length-i.pieceNum_}function rt(i){let e=i.pieceNum_;return e<i.pieces_.length&&e++,new Ze(i.pieces_,e)}function ry(i){return i.pieceNum_<i.pieces_.length?i.pieces_[i.pieces_.length-1]:null}function _k(i){let e="";for(let t=i.pieceNum_;t<i.pieces_.length;t++)i.pieces_[t]!==""&&(e+="/"+encodeURIComponent(String(i.pieces_[t])));return e||"/"}function oc(i,e=0){return i.pieces_.slice(i.pieceNum_+e)}function oC(i){if(i.pieceNum_>=i.pieces_.length)return null;const e=[];for(let t=i.pieceNum_;t<i.pieces_.length-1;t++)e.push(i.pieces_[t]);return new Ze(e,0)}function bt(i,e){const t=[];for(let s=i.pieceNum_;s<i.pieces_.length;s++)t.push(i.pieces_[s]);if(e instanceof Ze)for(let s=e.pieceNum_;s<e.pieces_.length;s++)t.push(e.pieces_[s]);else{const s=e.split("/");for(let a=0;a<s.length;a++)s[a].length>0&&t.push(s[a])}return new Ze(t,0)}function De(i){return i.pieceNum_>=i.pieces_.length}function wn(i,e){const t=Re(i),s=Re(e);if(t===null)return e;if(t===s)return wn(rt(i),rt(e));throw new Error("INTERNAL ERROR: innerPath ("+e+") is not within outerPath ("+i+")")}function yk(i,e){const t=oc(i,0),s=oc(e,0);for(let a=0;a<t.length&&a<s.length;a++){const l=Ua(t[a],s[a]);if(l!==0)return l}return t.length===s.length?0:t.length<s.length?-1:1}function ay(i,e){if(Ir(i)!==Ir(e))return!1;for(let t=i.pieceNum_,s=e.pieceNum_;t<=i.pieces_.length;t++,s++)if(i.pieces_[t]!==e.pieces_[s])return!1;return!0}function ei(i,e){let t=i.pieceNum_,s=e.pieceNum_;if(Ir(i)>Ir(e))return!1;for(;t<i.pieces_.length;){if(i.pieces_[t]!==e.pieces_[s])return!1;++t,++s}return!0}class vk{constructor(e,t){this.errorPrefix_=t,this.parts_=oc(e,0),this.byteLength_=Math.max(1,this.parts_.length);for(let s=0;s<this.parts_.length;s++)this.byteLength_+=id(this.parts_[s]);lC(this)}}function Ek(i,e){i.parts_.length>0&&(i.byteLength_+=1),i.parts_.push(e),i.byteLength_+=id(e),lC(i)}function Tk(i){const e=i.parts_.pop();i.byteLength_-=id(e),i.parts_.length>0&&(i.byteLength_-=1)}function lC(i){if(i.byteLength_>HS)throw new Error(i.errorPrefix_+"has a key path longer than "+HS+" bytes ("+i.byteLength_+").");if(i.parts_.length>jS)throw new Error(i.errorPrefix_+"path specified exceeds the maximum depth that can be written ("+jS+") or object contains a cycle "+ya(i))}function ya(i){return i.parts_.length===0?"":"in property '"+i.parts_.join(".")+"'"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let rf;class uC extends Od{static get __EMPTY_NODE(){return rf}static set __EMPTY_NODE(e){rf=e}compare(e,t){return Ua(e.name,t.name)}isDefinedOn(e){throw al("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return Oe.MIN}maxPost(){return new Oe(Oa,rf)}makePost(e,t){return ne(typeof e=="string","KeyIndex indexValue must always be a string."),new Oe(e,rf)}toString(){return".key"}}const Ho=new uC;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let zg;function Ik(i){zg=i}const cC=function(i){return typeof i=="number"?"number:"+Fb(i):"string:"+i},hC=function(i){if(i.isLeafNode()){const e=i.val();ne(typeof e=="string"||typeof e=="number"||typeof e=="object"&&qi(e,".sv"),"Priority must be a string or number.")}else ne(i===zg||i.isEmpty(),"priority of unexpected type.");ne(i===zg||i.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Mk=Math.log(2);class xk{constructor(e){const t=l=>parseInt(Math.log(l)/Mk,10),s=l=>parseInt(Array(l+1).join("1"),2);this.count=t(e+1),this.current_=this.count-1;const a=s(this.count);this.bits_=e+1&a}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const jf=function(i,e,t,s){i.sort(e);const a=function(p,g){const v=g-p;let T,A;if(v===0)return null;if(v===1)return T=i[p],A=t?t(T):T,new Xt(A,T.node,Xt.BLACK,null,null);{const O=parseInt(v/2,10)+p,q=a(p,O),Z=a(O+1,g);return T=i[O],A=t?t(T):T,new Xt(A,T.node,Xt.BLACK,q,Z)}},l=function(p){let g=null,v=null,T=i.length;const A=function(q,Z){const W=T-q,pe=T;T-=q;const de=a(W+1,pe),ue=i[W],Fe=t?t(ue):ue;O(new Xt(Fe,ue.node,Z,null,de))},O=function(q){g?(g.left=q,g=q):(v=q,g=q)};for(let q=0;q<p.count;++q){const Z=p.nextBitIsOne(),W=Math.pow(2,p.count-(q+1));Z?A(W,Xt.BLACK):(A(W,Xt.BLACK),A(W,Xt.RED))}return v},c=new xk(i.length),d=l(c);return new bn(s||e,d)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let og;const xo={};class vs{static get Default(){return ne(xo&&pt,"ChildrenNode.ts has not been loaded"),og=og||new vs({".priority":xo},{".priority":pt}),og}constructor(e,t){this.indexes_=e,this.indexSet_=t}get(e){const t=Qo(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof bn?t:null}hasIndex(e){return qi(this.indexSet_,e.toString())}addIndex(e,t){ne(e!==Ho,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const s=[];let a=!1;const l=t.getIterator(Oe.Wrap);let c=l.getNext();for(;c;)a=a||e.isDefinedOn(c.node),s.push(c),c=l.getNext();let d;a?d=jf(s,e.getCompare()):d=xo;const p=e.toString(),g={...this.indexSet_};g[p]=e;const v={...this.indexes_};return v[p]=d,new vs(v,g)}addToIndexes(e,t){const s=Tf(this.indexes_,(a,l)=>{const c=Qo(this.indexSet_,l);if(ne(c,"Missing index implementation for "+l),a===xo)if(c.isDefinedOn(e.node)){const d=[],p=t.getIterator(Oe.Wrap);let g=p.getNext();for(;g;)g.name!==e.name&&d.push(g),g=p.getNext();return d.push(e),jf(d,c.getCompare())}else return xo;else{const d=t.get(e.name);let p=a;return d&&(p=p.remove(new Oe(e.name,d))),p.insert(e,e.node)}});return new vs(s,this.indexSet_)}removeFromIndexes(e,t){const s=Tf(this.indexes_,a=>{if(a===xo)return a;{const l=t.get(e.name);return l?a.remove(new Oe(e.name,l)):a}});return new vs(s,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vk extends Od{constructor(e){super(),this.indexPath_=e,ne(!De(e)&&Re(e)!==".priority","Can't create PathIndex with empty path or .priority key")}extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){const s=this.extractChild(e.node),a=this.extractChild(t.node),l=s.compareTo(a);return l===0?Ua(e.name,t.name):l}makePost(e,t){const s=Ot(e),a=ve.EMPTY_NODE.updateChild(this.indexPath_,s);return new Oe(t,a)}maxPost(){const e=ve.EMPTY_NODE.updateChild(this.indexPath_,bc);return new Oe(Oa,e)}toString(){return oc(this.indexPath_,0).join("/")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mC(i){return{type:"value",snapshotNode:i}}function il(i,e){return{type:"child_added",snapshotNode:e,childName:i}}function lc(i,e){return{type:"child_removed",snapshotNode:e,childName:i}}function uc(i,e,t){return{type:"child_changed",snapshotNode:e,childName:i,oldSnap:t}}function zk(i,e){return{type:"child_moved",snapshotNode:e,childName:i}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class uy{constructor(e){this.index_=e}updateChild(e,t,s,a,l,c){ne(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const d=e.getImmediateChild(t);return d.getChild(a).equals(s.getChild(a))&&d.isEmpty()===s.isEmpty()||(c!=null&&(s.isEmpty()?e.hasChild(t)?c.trackChildChange(lc(t,d)):ne(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):d.isEmpty()?c.trackChildChange(il(t,s)):c.trackChildChange(uc(t,s,d))),e.isLeafNode()&&s.isEmpty())?e:e.updateImmediateChild(t,s).withIndex(this.index_)}updateFullNode(e,t,s){return s!=null&&(e.isLeafNode()||e.forEachChild(pt,(a,l)=>{t.hasChild(a)||s.trackChildChange(lc(a,l))}),t.isLeafNode()||t.forEachChild(pt,(a,l)=>{if(e.hasChild(a)){const c=e.getImmediateChild(a);c.equals(l)||s.trackChildChange(uc(a,l,c))}else s.trackChildChange(il(a,l))})),t.withIndex(this.index_)}updatePriority(e,t){return e.isEmpty()?ve.EMPTY_NODE:e.updatePriority(t)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Gf(){return{value:null,children:new Map}}function pl(i,e,t){if(De(e))i.value=t,i.children.clear();else if(i.value!==null)i.value=i.value.updateChild(e,t);else{const s=Re(e);i.children.has(s)||i.children.set(s,Gf());const a=i.children.get(s);e=rt(e),pl(a,e,t)}}function qg(i,e){if(De(e))return i.value=null,i.children.clear(),!0;if(i.value!==null){if(i.value.isLeafNode())return!1;{const t=i.value;return i.value=null,t.forEachChild(pt,(s,a)=>{pl(i,new Ze(s),a)}),qg(i,e)}}else if(i.children.size>0){const t=Re(e);return e=rt(e),i.children.has(t)&&qg(i.children.get(t),e)&&i.children.delete(t),i.children.size===0}else return!0}function Bg(i,e,t){i.value!==null?t(e,i.value):jk(i,(s,a)=>{const l=new Ze(e.toString()+"/"+s);Bg(a,l,t)})}function jk(i,e){i.children.forEach((t,s)=>{e(s,t)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const WS=10*1e3,Gk=30*1e3,Qk=300*1e3;class Yk{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new Hk(e);const s=WS+(Gk-WS)*Math.random();ju(this.reportStats_.bind(this),Math.floor(s))}reportStats_(){const e=this.statsListener_.get(),t={};let s=!1;mn(e,(a,l)=>{l>0&&qi(this.statsToReport_,a)&&(t[a]=l,s=!0)}),s&&this.server_.reportStats(t),ju(this.reportStats_.bind(this),Math.floor(Math.random()*2*Qk))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hc{constructor(e,t){this.source=e,this.path=t,this.type=ui.LISTEN_COMPLETE}operationForChild(e){return De(this.path)?new hc(this.source,Ge()):new hc(this.source,rt(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fc{constructor(e,t,s){this.source=e,this.path=t,this.children=s,this.type=ui.MERGE}operationForChild(e){if(De(this.path)){const t=this.children.subtree(new Ze(e));return t.isEmpty()?null:t.value?new Ma(this.source,Ge(),t.value):new fc(this.source,Ge(),t)}else return ne(Re(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new fc(this.source,rt(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Kk{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function Xk(i,e,t,s){const a=[],l=[];return e.forEach(c=>{c.type==="child_changed"&&i.index_.indexedValueChanged(c.oldSnap,c.snapshotNode)&&l.push(zk(c.childName,c.snapshotNode))}),Du(i,a,"child_removed",e,s,t),Du(i,a,"child_added",e,s,t),Du(i,a,"child_moved",l,s,t),Du(i,a,"child_changed",e,s,t),Du(i,a,"value",e,s,t),a}function Du(i,e,t,s,a,l){const c=s.filter(d=>d.type===t);c.sort((d,p)=>$k(i,d,p)),c.forEach(d=>{const p=Wk(i,d,l);a.forEach(g=>{g.respondsTo(d.type)&&e.push(g.createEvent(p,i.query_))})})}function Wk(i,e,t){return e.type==="value"||e.type==="child_removed"||(e.prevName=t.getPredecessorChildName(e.childName,e.snapshotNode,i.index_)),e}function $k(i,e,t){if(e.childName==null||t.childName==null)throw al("Should only compare child_ events.");const s=new Oe(e.childName,e.snapshotNode),a=new Oe(t.childName,t.snapshotNode);return i.index_.compare(s,a)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fP{constructor(){this.changeMap=new Map}trackChildChange(e){const t=e.type,s=e.childName;ne(t==="child_added"||t==="child_changed"||t==="child_removed","Only child changes supported for tracking"),ne(s!==".priority","Only non-priority child changes can be tracked.");const a=this.changeMap.get(s);if(a){const l=a.type;if(t==="child_added"&&l==="child_removed")this.changeMap.set(s,uc(s,e.snapshotNode,a.snapshotNode));else if(t==="child_removed"&&l==="child_added")this.changeMap.delete(s);else if(t==="child_removed"&&l==="child_changed")this.changeMap.set(s,lc(s,a.oldSnap));else if(t==="child_changed"&&l==="child_added")this.changeMap.set(s,il(s,e.snapshotNode));else if(t==="child_changed"&&l==="child_changed")this.changeMap.set(s,uc(s,e.snapshotNode,a.oldSnap));else throw al("Illegal combination of changes: "+e+" occurred after "+a)}else this.changeMap.set(s,e)}getChanges(){return Array.from(this.changeMap.values())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oV{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Iy(i,e){let t=null;for(let s=0;s<e.length;s++){const a=e[s],l=a.getPath();t!==null&&!ay(l,t.path)&&(i.eventLists_.push(t),t=null),t===null&&(t={events:[],path:l}),t.events.push(a)}t&&i.eventLists_.push(t)}function zC(i,e,t){Iy(i,t),qC(i,s=>ay(s,e))}function Rs(i,e,t){Iy(i,t),qC(i,s=>ei(s,e)||ei(e,s))}function qC(i,e){i.recursionDepth_++;let t=!0;for(let s=0;s<i.eventLists_.length;s++){const a=i.eventLists_[s];if(a){const l=a.path;e(l)?(lV(i.eventLists_[s]),i.eventLists_[s]=null):t=!1}}t&&(i.eventLists_=[]),i.recursionDepth_--}function lV(i){for(let e=0;e<i.events.length;e++){const t=i.events[e];if(t!==null){i.events[e]=null;const s=t.getEventRunner();Fu&&sn("event: "+t.toString()),ml(s)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class OV{constructor(e,t){this._repo=e,this._path=t}cancel(){const e=new ms;return _V(this._repo,this._path,e.wrapCallback(()=>{})),e.promise}remove(){Pu("OnDisconnect.remove",this._path);const e=new ms;return hA(this._repo,this._path,null,e.wrapCallback(()=>{})),e.promise}set(e){Pu("OnDisconnect.set",this._path),Xg("OnDisconnect.set",e,this._path);const t=new ms;return hA(this._repo,this._path,e,t.wrapCallback(()=>{})),t.promise}setWithPriority(e,t){Pu("OnDisconnect.setWithPriority",this._path),Xg("OnDisconnect.setWithPriority",e,this._path),sV("OnDisconnect.setWithPriority",t);const s=new ms;return yV(this._repo,this._path,e,t,s.wrapCallback(()=>{})),s.promise}update(e){Pu("OnDisconnect.update",this._path),iV("OnDisconnect.update",e,this._path);const t=new ms;return vV(this._repo,this._path,e,t.wrapCallback(()=>{})),t.promise}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
