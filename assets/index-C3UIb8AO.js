 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rI="FirebaseError";class Ns extends Error{constructor(e,t,s){super(t),this.code=e,this.customData=s,this.name=rI,Object.setPrototypeOf(this,Ns.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,fc.prototype.create)}}class fc{constructor(e,t,s){this.service=e,this.serviceName=t,this.errors=s}create(e,...t){const s=t[0]||{},a=`${this.service}/${e}`,l=this.errors[e],c=l?aI(l,s):"Error",d=`${this.serviceName}: ${c} (${a}).`;return new Ns(a,d,s)}}function aI(i,e){return i.replace(oI,(t,s)=>{const a=e[s];return a!=null?String(a):`<${s}?>`})}const oI=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const As=new sd("@firebase/app"),VI="@firebase/app-compat",LI="@firebase/analytics-compat",UI="@firebase/analytics",zI="@firebase/app-check-compat",qI="@firebase/app-check",BI="@firebase/auth",FI="@firebase/auth-compat",jI="@firebase/database",HI="@firebase/data-connect",GI="@firebase/database-compat",QI="@firebase/functions",YI="@firebase/functions-compat",KI="@firebase/installations",XI="@firebase/installations-compat",WI="@firebase/messaging",$I="@firebase/messaging-compat",ZI="@firebase/performance",JI="@firebase/performance-compat",eN="@firebase/remote-config",tN="@firebase/remote-config-compat",nN="@firebase/storage",iN="@firebase/storage-compat",sN="@firebase/firestore",rN="@firebase/ai",aN="@firebase/firestore-compat",oN="firebase",lN="12.1.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pa=lN;function PA(i,e={}){let t=i;typeof e!="object"&&(e={name:e});const s={name:mg,automaticDataCollectionEnabled:!0,...e},a=s.name;if(typeof a!="string"||!a)throw dr.create("bad-app-name",{appName:String(a)});if(t||(t=IA()),!t)throw dr.create("no-options");const l=Sf.get(a);if(l){if(vr(t,l.options)&&vr(s,l.config))return l;throw dr.create("duplicate-app",{appName:a})}const c=new yI(a);for(const p of pg.values())c.addComponent(p);const d=new fN(t,s,c);return Sf.set(a,d),d}function r_(i=mg){const e=Sf.get(i);if(!e&&i===mg&&IA())return PA();if(!e)throw dr.create("no-app",{appName:i});return e}function xi(i,e,t){let s=uN[i]??i;t&&(s+=`-${t}`);const a=s.match(/\s|\//),l=e.match(/\s|\//);if(a||l){const c=[`Unable to register library "${s}" with version "${e}":`];a&&c.push(`library name "${s}" contains illegal characters (whitespace or "/")`),a&&l&&c.push("and"),l&&c.push(`version name "${e}" contains illegal characters (whitespace or "/")`),As.warn(c.join(" "));return}Ca(new Er(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dN="firebase-heartbeat-database",mN=1,Ku="firebase-heartbeat-store";let Wp=null;function VA(){return Wp||(Wp=OI(dN,mN,{upgrade:(i,e)=>{switch(e){case 0:try{i.createObjectStore(Ku)}catch(t){console.warn(t)}}}}).catch(i=>{throw dr.create("idb-open",{originalErrorMessage:i.message})})),Wp}async function pN(i){try{const t=(await VA()).transaction(Ku),s=await t.objectStore(Ku).get(LA(i));return await t.done,s}catch(e){if(e instanceof Ns)As.warn(e.message);else{const t=dr.create("idb-get",{originalErrorMessage:e?.message});As.warn(t.message)}}}async function c0(i,e){try{const s=(await VA()).transaction(Ku,"readwrite");await s.objectStore(Ku).put(e,LA(i)),await s.done}catch(t){if(t instanceof Ns)As.warn(t.message);else{const s=dr.create("idb-set",{originalErrorMessage:t?.message});As.warn(s.message)}}}function LA(i){return`${i.name}!${i.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function SN(i){Ca(new Er("platform-logger",e=>new kI(e),"PRIVATE")),Ca(new Er("heartbeat",e=>new yN(e),"PRIVATE")),xi(dg,l0,i),xi(dg,l0,"esm2020"),xi("fire-js","")}SN("");var AN="firebase",wN="12.1.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dc{constructor(e,t){this.shortDelay=e,this.longDelay=t,ws(t>e,"Short delay should be less than long delay!"),this.isMobile=i_()||OA()}get(){return NN()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function l_(i,e){ws(i.emulator,"Emulator should always be set here");const{url:t}=i.emulator;return e?`${t}${e.startsWith("/")?e.slice(1):e}`:t}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Xu(i,e,t=!1){if(t)return e;try{return await e}catch(s){throw s instanceof Ns&&UN(s)&&i.auth.currentUser===i&&await i.auth.signOut(),s}}function UN({code:i}){return i==="auth/user-disabled"||i==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const p0=new Map;function ys(i){ws(i instanceof Function,"Expected a class definition");let e=p0.get(i);return e?(ws(e instanceof i,"Instance stored in cache mismatched with class"),e):(e=new i,p0.set(i,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function tD(i,e){const t=rd(i,"auth");if(t.isInitialized()){const a=t.getImmediate(),l=t.getOptions();if(vr(l,e??{}))return a;Ui(a,"already-initialized")}return t.initialize({options:e})}function nD(i,e){const t=e?.persistence||[],s=(Array.isArray(t)?t:[t]).map(ys);e?.errorMap&&i._updateErrorMap(e.errorMap),i._initializeWithPersistence(s,e?.popupRedirectResolver)}function iD(i,e,t){const s=ad(i);Ee(/^https?:\/\//.test(e),s,"invalid-emulator-scheme");const a=!1,l=ew(e),{host:c,port:d}=sD(e),p=d===null?"":`:${d}`,g={url:`${l}//${c}${p}/`},v=Object.freeze({host:c,port:d,protocol:l.replace(":",""),options:Object.freeze({disableWarnings:a})});if(!s._canInitEmulator){Ee(s.config.emulator&&s.emulatorConfig,s,"emulator-config-failed"),Ee(vr(g,s.config.emulator)&&vr(v,s.emulatorConfig),s,"emulator-config-failed");return}s.config.emulator=g,s.emulatorConfig=v,s.settings.appVerificationDisabledForTesting=!0,Dr(c)?(t_(`${l}//${c}${p}`),n_("Auth",!0)):rD()}function ew(i){const e=i.indexOf(":");return e<0?"":i.substr(0,e+1)}function sD(i){const e=ew(i),t=/(\/\/)?([^?#/]+)/.exec(i.substr(e.length));if(!t)return{host:"",port:null};const s=t[2].split("@").pop()||"",a=/^(\[[^\]]+\])(:|$)/.exec(s);if(a){const l=a[1];return{host:l,port:v0(s.substr(l.length+1))}}else{const[l,c]=s.split(":");return{host:l,port:v0(c)}}}function v0(i){if(!i)return null;const e=Number(i);return isNaN(e)?null:e}function rD(){function i(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",i):i())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zp="webStorageSupport";class g2{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=aw,this._completeRedirectFn=qD,this._overrideRedirectResult=LD}async _openPopup(e,t,s,a){ws(this.eventManagers[e._key()]?.manager,"_initialize() not called before _openPopup()");const l=await C0(e,t,s,gg(),a);return c2(e,l,m_())}async _openRedirect(e,t,s,a){await this._originValidation(e);const l=await C0(e,t,s,gg(),a);return vD(l),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:a,promise:l}=this.eventManagers[t];return a?Promise.resolve(a):(ws(l,"If manager is not set, promise should be"),l)}const s=this.initAndGetManager(e);return this.eventManagers[t]={promise:s},s.catch(()=>{delete this.eventManagers[t]}),s}async initAndGetManager(e){const t=await s2(e),s=new FD(e);return t.register("authEvent",a=>(Ee(a?.authEvent,e,"invalid-auth-event"),{status:s.onEvent(a.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:s},this.iframes[e._key()]=t,s}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(Zp,{type:Zp},a=>{const l=a?.[0]?.[Zp];l!==void 0&&t(!!l),Ui(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=YD(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return ZA()||QA()||h_()}}const _2=g2;var R0="@firebase/auth",I0="1.11.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function v2(i){switch(i){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function E2(i){Ca(new Er("auth",(e,{options:t})=>{const s=e.getProvider("app").getImmediate(),a=e.getProvider("heartbeat"),l=e.getProvider("app-check-internal"),{apiKey:c,authDomain:d}=s.options;Ee(c&&!c.includes(":"),"invalid-api-key",{appName:s.name});const p={apiKey:c,authDomain:d,clientPlatform:i,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:JA(i)},g=new WN(s,a,l,p);return nD(g,t),g},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,s)=>{e.getProvider("auth-internal").initialize()})),Ca(new Er("auth-internal",e=>{const t=ad(e.getProvider("auth").getImmediate());return(s=>new y2(s))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),xi(R0,I0,v2(i)),xi(R0,I0,"esm2020")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var mr,mw;(function(){var i;/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ia=new sd("@firebase/firestore");function ko(){return Ia.logLevel}function ae(i,...e){if(Ia.logLevel<=ke.DEBUG){const t=e.map(g_);Ia.debug(`Firestore (${ul}): ${i}`,...t)}}function bs(i,...e){if(Ia.logLevel<=ke.ERROR){const t=e.map(g_);Ia.error(`Firestore (${ul}): ${i}`,...t)}}function Xo(i,...e){if(Ia.logLevel<=ke.WARN){const t=e.map(g_);Ia.warn(`Firestore (${ul}): ${i}`,...t)}}function g_(i){if(typeof i=="string")return i;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _e(i,e,t){let s="Unexpected state";typeof e=="string"?s=e:t=e,Ew(i,s,t)}function Ew(i,e,t){let s=`FIRESTORE (${ul}) INTERNAL ASSERTION FAILED: ${e} (ID: ${i.toString(16)})`;if(t!==void 0)try{s+=" CONTEXT: "+JSON.stringify(t)}catch{s+=" CONTEXT: "+t}throw bs(s),new Error(s)}function Xe(i,e,t,s){let a="Unexpected state";typeof t=="string"?a=t:s=t,i||Ew(e,a,s)}function Ae(i,e){return i}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class an{constructor(e){this.binaryString=e}static fromBase64String(e){const t=(function(a){try{return atob(a)}catch(l){throw typeof DOMException<"u"&&l instanceof DOMException?new Cw("Invalid base64 string: "+l):l}})(e);return new an(t)}static fromUint8Array(e){const t=(function(a){let l="";for(let c=0;c<a.length;++c)l+=String.fromCharCode(a[c]);return l})(e);return new an(t)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return(function(t){return btoa(t)})(this.binaryString)}toUint8Array(){return(function(t){const s=new Uint8Array(t.length);for(let a=0;a<t.length;a++)s[a]=t.charCodeAt(a);return s})(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return Pe(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}an.EMPTY_BYTE_STRING=new an("");const Q2=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function Sr(i){if(Xe(!!i,39018),typeof i=="string"){let e=0;const t=Q2.exec(i);if(Xe(!!t,46558,{timestamp:i}),t[1]){let a=t[1];a=(a+"000000000").substr(0,9),e=Number(a)}const s=new Date(i);return{seconds:Math.floor(s.getTime()/1e3),nanos:e}}return{seconds:wt(i.seconds),nanos:wt(i.nanos)}}function wt(i){return typeof i=="number"?i:typeof i=="string"?Number(i):0}function Ar(i){return typeof i=="string"?an.fromBase64String(i):an.fromUint8Array(i)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rw="server_timestamp",Iw="__type__",Nw="__previous_value__",Dw="__local_write_time__";function v_(i){return(i?.mapValue?.fields||{})[Iw]?.stringValue===Rw}function fd(i){const e=i.mapValue.fields[Nw];return v_(e)?fd(e):e}function $u(i){const e=Sr(i.mapValue.fields[Dw].timestampValue);return new ct(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const DO=new mr([4294967295,4294967295],0);function tS(i){const e=NO().encode(i),t=new mw;return t.update(e),new Uint8Array(t.digest())}function nS(i){const e=new DataView(i.buffer),t=e.getUint32(0,!0),s=e.getUint32(4,!0),a=e.getUint32(8,!0),l=e.getUint32(12,!0);return[new mr([t,s],0),new mr([a,l],0)]}class b_{constructor(e,t,s){if(this.bitmap=e,this.padding=t,this.hashCount=s,t<0||t>=8)throw new Mu(`Invalid padding: ${t}`);if(s<0)throw new Mu(`Invalid hash count: ${s}`);if(e.length>0&&this.hashCount===0)throw new Mu(`Invalid hash count: ${s}`);if(e.length===0&&t!==0)throw new Mu(`Invalid padding when bitmap length is 0: ${t}`);this.ge=8*e.length-t,this.pe=mr.fromNumber(this.ge)}ye(e,t,s){let a=e.add(t.multiply(mr.fromNumber(s)));return a.compare(DO)===1&&(a=new mr([a.getBits(0),a.getBits(1)],0)),a.modulo(this.pe).toNumber()}we(e){return!!(this.bitmap[Math.floor(e/8)]&1<<e%8)}mightContain(e){if(this.ge===0)return!1;const t=tS(e),[s,a]=nS(t);for(let l=0;l<this.hashCount;l++){const c=this.ye(s,a,l);if(!this.we(c))return!1}return!0}static create(e,t,s){const a=e%8==0?0:8-e%8,l=new Uint8Array(Math.ceil(e/8)),c=new b_(l,a,t);return s.forEach((d=>c.insert(d))),c}insert(e){if(this.ge===0)return;const t=tS(e),[s,a]=nS(t);for(let l=0;l<this.hashCount;l++){const c=this.ye(s,a,l);this.Se(c)}}Se(e){const t=Math.floor(e/8),s=e%8;this.bitmap[t]|=1<<s}}class Mu extends Error{constructor(){super(...arguments),this.name="BloomFilterError"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yd{constructor(e,t,s,a,l){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=s,this.documentUpdates=a,this.resolvedLimboDocuments=l}static createSynthesizedRemoteEventForCurrentChange(e,t,s){const a=new Map;return a.set(e,yc.createSynthesizedTargetChangeForCurrentChange(e,t,s)),new yd(Se.min(),a,new kt(Pe),Cs(),Ve())}}class yc{constructor(e,t,s,a,l){this.resumeToken=e,this.current=t,this.addedDocuments=s,this.modifiedDocuments=a,this.removedDocuments=l}static createSynthesizedTargetChangeForCurrentChange(e,t,s){return new yc(s,t,Ve(),Ve(),Ve())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class j_{constructor(e){this.observer=e,this.muted=!1}next(e){this.muted||this.observer.next&&this.Ou(this.observer.next,e)}error(e){this.muted||(this.observer.error?this.Ou(this.observer.error,e):bs("Uncaught Error in snapshot listener:",e.toString()))}Nu(){this.muted=!0}Ou(e,t){setTimeout((()=>{this.muted||e(t)}),0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ds{constructor(e,t,s){this.converter=t,this._query=s,this.type="query",this.firestore=e}withConverter(e){return new Ds(this.firestore,e,this._query)}}class Et{constructor(e,t,s){this.converter=t,this._key=s,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new gr(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new Et(this.firestore,e,this._key)}toJSON(){return{type:Et._jsonSchemaVersion,referencePath:this._key.toString()}}static fromJSON(e,t,s){if(gc(t,Et._jsonSchema))return new Et(e,s||null,new he(lt.fromString(t.referencePath)))}}Et._jsonSchemaVersion="firestore/documentReference/1.0",Et._jsonSchema={type:Mt("string",Et._jsonSchemaVersion),referencePath:Mt("string")};class gr extends Ds{constructor(e,t,s){super(e,t,dd(s)),this._path=s,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new Et(this.firestore,null,new he(e))}withConverter(e){return new gr(this.firestore,e,this._path)}}function _r(i,e,...t){if(i=dt(i),Sw("collection","path",e),i instanceof Sd){const s=lt.fromString(e,...t);return V0(s),new gr(i,null,s)}{if(!(i instanceof Et||i instanceof gr))throw new re(K.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const s=i._path.child(lt.fromString(e,...t));return V0(s),new gr(i.firestore,null,s)}}function Da(i,e,...t){if(i=dt(i),arguments.length===1&&(e=__.newId()),Sw("doc","path",e),i instanceof Sd){const s=lt.fromString(e,...t);return P0(s),new Et(i,null,new he(s))}{if(!(i instanceof Et||i instanceof gr))throw new re(K.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const s=i._path.child(lt.fromString(e,...t));return P0(s),new Et(i.firestore,i instanceof gr?i.converter:null,new he(s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function jb(i){i=Un(i,Et);const e=Un(i.firestore,Rr);return EM(Ad(e),i._key).then((t=>Gb(e,i,t)))}ba._jsonSchemaVersion="firestore/querySnapshot/1.0",ba._jsonSchema={type:Mt("string",ba._jsonSchemaVersion),bundleSource:Mt("string","QuerySnapshot"),bundleName:Mt("string"),bundle:Mt("string")};class J_ extends PM{constructor(e){super(),this.firestore=e}convertBytes(e){return new Jn(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new Et(this.firestore,null,t)}}function DS(i){i=Un(i,Ds);const e=Un(i.firestore,Rr),t=Ad(e),s=new J_(e);return qb(i._query),TM(t,i._query).then((a=>new ba(e,s,i,a)))}function LM(i,e,t){i=Un(i,Et);const s=Un(i.firestore,Rr),a=Fb(i.converter,e);return ey(s,[Pb(Cd(s),"setDoc",i._key,a,i.converter!==null,t).toMutation(i._key,hi.none())])}function sc(i,e,t,...s){i=Un(i,Et);const a=Un(i.firestore,Rr),l=Cd(a);let c;return c=typeof(e=dt(e))=="string"||e instanceof wd?NM(l,"updateDoc",i._key,e,t,s):IM(l,"updateDoc",i._key,e),ey(a,[c.toMutation(i._key,hi.exists(!0))])}function Hb(i,e){const t=Un(i.firestore,Rr),s=Da(i),a=Fb(i.converter,e);return ey(t,[Pb(Cd(i.firestore),"addDoc",s._key,a,i.converter!==null,{}).toMutation(s._key,hi.exists(!1))]).then((()=>s))}function Sc(i,...e){i=dt(i);let t={includeMetadataChanges:!1,source:"default"},s=0;typeof e[s]!="object"||RS(e[s])||(t=e[s++]);const a={includeMetadataChanges:t.includeMetadataChanges,source:t.source};if(RS(e[s])){const p=e[s];e[s]=p.next?.bind(p),e[s+1]=p.error?.bind(p),e[s+2]=p.complete?.bind(p)}let l,c,d;if(i instanceof Et)c=Un(i.firestore,Rr),d=dd(i._key.path),l={next:p=>{e[s]&&e[s](Gb(c,i,p))},error:e[s+1],complete:e[s+2]};else{const p=Un(i,Ds);c=Un(p.firestore,Rr),d=p._query;const g=new J_(c);l={next:v=>{e[s]&&e[s](new ba(c,g,p,v))},error:e[s+1],complete:e[s+2]},qb(i._query)}return(function(g,v,T,A){const D=new j_(A),U=new q_(v,D,T);return g.asyncQueue.enqueueAndForget((async()=>L_(await zf(g),U))),()=>{D.Nu(),g.asyncQueue.enqueueAndForget((async()=>U_(await zf(g),U)))}})(Ad(c),d,a,l)}function ey(i,e){return(function(s,a){const l=new Es;return s.asyncQueue.enqueueAndForget((async()=>lM(await vM(s),a,l))),l.promise})(Ad(i),e)}function Gb(i,e,t){const s=t.docs.get(e._key),a=new J_(i);return new wa(i,a,e._key,s,new ku(t.hasPendingWrites,t.fromCache),e.converter)}function hr(){return new G_("serverTimestamp")}(function(e,t=!0){(function(a){ul=a})(Pa),Ca(new Er("firestore",((s,{instanceIdentifier:a,options:l})=>{const c=s.getProvider("app").getImmediate(),d=new Rr(new I2(s.getProvider("auth-internal")),new O2(c,s.getProvider("app-check-internal")),(function(g,v){if(!Object.prototype.hasOwnProperty.apply(g.options,["projectId"]))throw new re(K.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Zu(g.options.projectId,v)})(c,a),c);return l={useFetchStreams:t,...l},d._setSettings(l),d}),"PUBLIC").setMultipleInstances(!0)),xi(O0,x0,e),xi(O0,x0,"esm2020")})();var OS={};const xS="@firebase/database",MS="1.1.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _V{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Iy(i,e){let t=null;for(let s=0;s<e.length;s++){const a=e[s],l=a.getPath();t!==null&&!ay(l,t.path)&&(i.eventLists_.push(t),t=null),t===null&&(t={events:[],path:l}),t.events.push(a)}t&&i.eventLists_.push(t)}function YC(i,e,t){Iy(i,t),KC(i,s=>ay(s,e))}function Is(i,e,t){Iy(i,t),KC(i,s=>ei(s,e)||ei(e,s))}function KC(i,e){i.recursionDepth_++;let t=!0;for(let s=0;s<i.eventLists_.length;s++){const a=i.eventLists_[s];if(a){const l=a.path;e(l)?(yV(i.eventLists_[s]),i.eventLists_[s]=null):t=!1}}t&&(i.eventLists_=[]),i.recursionDepth_--}function yV(i){for(let e=0;e<i.events.length;e++){const t=i.events[e];if(t!==null){i.events[e]=null;const s=t.getEventRunner();Fu&&sn("event: "+t.toString()),ml(s)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const HV="FIREBASE_DATABASE_EMULATOR_HOST",$g={};let GV=!1;function QV(i,e,t,s){const a=e.lastIndexOf(":"),l=e.substring(0,a),c=Dr(l);i.repoInfo_=new aC(e,c,i.repoInfo_.namespace,i.repoInfo_.webSocketOnly,i.repoInfo_.nodeAdmin,i.repoInfo_.persistenceKey,i.repoInfo_.includeNamespaceInQueryParams,!0,t),s&&(i.authTokenProvider_=s)}function YV(i,e,t,s,a){let l=s||i.options.databaseURL;l===void 0&&(i.options.projectId||Rs("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),sn("Using default host for project ",i.options.projectId),l=`${i.options.projectId}-default-rtdb.firebaseio.com`);let c=fA(l,a),d=c.repoInfo,p;typeof process<"u"&&OS&&(p=OS[HV]),p?(l=`http://${p}?ns=${d.namespace}`,c=fA(l,a),d=c.repoInfo):c.repoInfo.secure;const g=new tk(i.name,i.options,e);gV("Invalid Firebase Database URL",c),De(c.path)||Rs("Database URL must point to the root of a Firebase Database (not including a child path).");const v=XV(d,i,g,new ek(i,t));return new WV(v,i)}function KV(i,e){const t=$g[e];(!t||t[i.key]!==i)&&Rs(`Database ${e}(${i.repoInfo_}) has already been deleted.`),xV(i),delete t[i.key]}function XV(i,e,t,s){let a=$g[e.name];a||(a={},$g[e.name]=a);let l=a[i.toURLString()];return l&&Rs("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),l=new TV(i,GV,t,s),a[i.toURLString()]=l,l}class WV{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(SV(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Mr(this._repo,Qe())),this._rootInternal}_delete(){return this._rootInternal!==null&&(KV(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){this._rootInternal===null&&Rs("Cannot call "+e+" on a deleted database.")}}function $V(i=r_(),e){const t=rd(i,"database").getImmediate({identifier:e});if(!t._instanceStarted){const s=RA("database");s&&ZV(t,...s)}return t}function ZV(i,e,t,s={}){i=dt(i),i._checkNotDeleted("useEmulator");const a=`${e}:${t}`,l=i._repoInternal;if(i._instanceStarted){if(a===i._repoInternal.repoInfo_.host&&vr(s,l.repoInfo_.emulatorOptions))return;Rs("connectDatabaseEmulator() cannot initialize or alter the emulator configuration after the database instance has started.")}let c;if(l.repoInfo_.nodeAdmin)s.mockUserToken&&Rs('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),c=new _f(_f.OWNER);else if(s.mockUserToken){const d=typeof s.mockUserToken=="string"?s.mockUserToken:DA(s.mockUserToken,i.app.options.projectId);c=new _f(d)}Dr(e)&&(t_(e),n_("Database",!0)),QV(l,a,s,c)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function JV(i){UM(Pa),Ca(new Er("database",(e,{instanceIdentifier:t})=>{const s=e.getProvider("app").getImmediate(),a=e.getProvider("auth-internal"),l=e.getProvider("app-check-internal");return YV(s,a,l,t)},"PUBLIC").setMultipleInstances(!0)),xi(xS,MS,i),xi(xS,MS,"esm2020")}Ss.prototype.simpleListen=function(i,e){this.sendRequest("q",{p:i},e)};Ss.prototype.echo=function(i,e){this.sendRequest("echo",{d:i},e)};JV();/**
