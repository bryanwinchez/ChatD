 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zD=new mc(3e4,6e4);function w0(){const i=xi().___jsl;if(i?.H){for(const e of Object.keys(i.H))if(i.H[e].r=i.H[e].r||[],i.H[e].L=i.H[e].L||[],i.H[e].r=[...i.H[e].L],i.CP)for(let t=0;t<i.CP.length;t++)i.CP[t]=null}}function BD(i){return new Promise((e,t)=>{function s(){w0(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{w0(),t(ci(i,"network-request-failed"))},timeout:zD.get()})}if(xi().gapi?.iframes?.Iframe)e(gapi.iframes.getContext());else if(xi().gapi?.load)s();else{const a=HN("iframefcb");return xi()[a]=()=>{gapi.load?s():t(ci(i,"network-request-failed"))},FN(`${jN()}?onload=${a}`).catch(l=>t(l))}}).catch(e=>{throw cf=null,e})}let cf=null;function qD(i){return cf=cf||BD(i),cf}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ec{constructor(e,t="asc"){this.field=e,this.dir=t}}function q2(i,e){return i.dir===e.dir&&i.field.isEqual(e.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tO=new kt(he.comparator);function bs(){return tO}const Pw=new kt(he.comparator);function Mu(...i){let e=Pw;for(const t of i)e=e.insert(t.key,t);return e}function Vw(i){let e=Pw;return i.forEach(((t,s)=>e=e.insert(t,s.overlayedDocument))),e}function Ea(){return Bu()}function Lw(){return Bu()}function Bu(){return new Va((i=>i.toString()),((i,e)=>i.isEqual(e)))}const nO=new kt(he.comparator),iO=new Bt(he.comparator);function Ve(...i){let e=iO;for(const t of i)e=e.add(t);return e}const sO=new Bt(Pe);function rO(){return sO}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gd{constructor(){this._=void 0}}function oO(i,e,t){return i instanceof tc?(function(a,l){const c={fields:{[Ew]:{stringValue:vw},[Sw]:{timestampValue:{seconds:a.seconds,nanos:a.nanoseconds}}}};return l&&v_(l)&&(l=fd(l)),l&&(c.fields[Tw]=l),{mapValue:c}})(t,e):i instanceof nc?Bw(i,e):i instanceof ic?qw(i,e):(function(a,l){const c=zw(a,l),d=$0(c)+$0(a.Ae);return Ag(c)&&Ag(a.Ae)?Uw(d):A_(a.serializer,d)})(i,e)}function lO(i,e,t){return i instanceof nc?Bw(i,e):i instanceof ic?qw(i,e):t}function zw(i,e){return i instanceof kf?(function(s){return Ag(s)||(function(l){return!!l&&"doubleValue"in l})(s)})(e)?e:{integerValue:0}:null}class tc extends gd{}class nc extends gd{constructor(e){super(),this.elements=e}}function Bw(i,e){const t=Fw(e);for(const s of i.elements)t.some((a=>zi(a,s)))||t.push(s);return{arrayValue:{values:t}}}class ic extends gd{constructor(e){super(),this.elements=e}}function qw(i,e){let t=Fw(e);for(const s of i.elements)t=t.filter((a=>!zi(a,s)));return{arrayValue:{values:t}}}class kf extends gd{constructor(e,t){super(),this.serializer=e,this.Ae=t}}function $0(i){return wt(i.integerValue||i.doubleValue)}function Fw(i){return E_(i)&&i.arrayValue.values?i.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Gf(){return{value:null,children:new Map}}function pl(i,e,t){if(De(e))i.value=t,i.children.clear();else if(i.value!==null)i.value=i.value.updateChild(e,t);else{const s=Re(e);i.children.has(s)||i.children.set(s,Gf());const a=i.children.get(s);e=rt(e),pl(a,e,t)}}function Bg(i,e){if(De(e))return i.value=null,i.children.clear(),!0;if(i.value!==null){if(i.value.isLeafNode())return!1;{const t=i.value;return i.value=null,t.forEachChild(pt,(s,a)=>{pl(i,new Ze(s),a)}),Bg(i,e)}}else if(i.children.size>0){const t=Re(e);return e=rt(e),i.children.has(t)&&Bg(i.children.get(t),e)&&i.children.delete(t),i.children.size===0}else return!0}function qg(i,e,t){i.value!==null?t(e,i.value):jk(i,(s,a)=>{const l=new Ze(e.toString()+"/"+s);qg(a,l,t)})}function jk(i,e){i.children.forEach((t,s)=>{e(s,t)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const WS=10*1e3,Gk=30*1e3,Qk=300*1e3;class Yk{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new Hk(e);const s=WS+(Gk-WS)*Math.random();ju(this.reportStats_.bind(this),Math.floor(s))}reportStats_(){const e=this.statsListener_.get(),t={};let s=!1;mn(e,(a,l)=>{l>0&&Bi(this.statsToReport_,a)&&(t[a]=l,s=!0)}),s&&this.server_.reportStats(t),ju(this.reportStats_.bind(this),Math.floor(Math.random()*2*Qk))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
